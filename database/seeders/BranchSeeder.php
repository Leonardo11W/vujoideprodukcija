    ...
    public function run()
    {
        if (env('IS_DUMMY_DATA')) {
            ...
            foreach ($branches as $branch) {
               ...
               $address['user_id'] = 1; // or any valid user ID
