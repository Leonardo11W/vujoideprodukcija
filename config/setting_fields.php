    ...
    'invoice_setting' => [
        ...
        'elements' => [
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'name' => 'inv_booking_prefix', // unique name for field
                'label' => 'lbl_booking_prefix', // you know what label it is
            ...
            [
                ...
                'name' => 'booking_code_start', // unique name for field
                'label' => 'lbl_booking_starts', // you know what label it is
                'rules' => 'nullable|max:191', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '1', // default value if you want
            ],
