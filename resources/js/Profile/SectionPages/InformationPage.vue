...
const handleInput = (phone, phoneObject) => {
  if (typeof phone === 'string') {
    mobile.value = phoneObject?.formatted || phone
  }
}

const validationSchema = yup.object({
  first_name: yup.string().required(() => t('profile.first_name_required')),
  last_name: yup.string().required(() => t('profile.last_name_required')),
  email: yup.string().required(() => t('profile.email_required')),
  mobile: yup.string().required(() => t('profile.mobile_required')).min(1, () => t('profile.mobile_required')),
  show_in_calender: yup.string().required(() => t('profile.show_in_calender_required'))
})
