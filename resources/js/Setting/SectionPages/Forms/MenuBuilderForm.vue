<template>
  <button v-if="hasPermissions('add_menu_builder')" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#menuBuilderModal" aria-controls="form-modal"><i class="fa fa-plus"></i> {{ $t('messages.new') }}</button>
  <div class="modal fade" id="menuBuilderModal" tabindex="-1" aria-labelledby="menuBuilderModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen-md-down">
      <form @submit.prevent="formSubmit">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="offcanvas-title" id="menuBuilderModalLabel">
...
import { closeModalAndCleanup } from '@/helpers/utilities'
...
useOnModalHide('menuBuilderModal', () => {
...
const reset_datatable_close_offcanvas = (res) => {
  if (res.status) {
    ...
    closeModalAndCleanup('menuBuilderModal')
    setFormData(defaultData())
    setTimeout(() => {
