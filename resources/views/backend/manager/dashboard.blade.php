...
<div class="row">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    @if(session('my_work_mode'))
      <h3>{{ __('dashboard.lbl_performance_of') }} {{ auth()->user()->full_name }}</h3>
    @else
      <h3>{{ __('dashboard.lbl_performance_of') }} {{ $selected_branch->name }}</h3>
    @endif
    ...
    <div class="row">
      ...
      @php
        $isMyWork = session('my_work_mode');
        $commissionLabel = $isMyWork ? __('dashboard.lbl_manager_commission') : __('dashboard.lbl_sales_commission');
      @endphp
      <div class="col-sm-6 col-lg-2">
        <div class="card dashboard-cards revenue"
          ...
          <div class="card-body">
            <div class="d-flex align-items-start justify-content-end mb-1">
              <i class="fa-solid fa-circle-info" data-bs-toggle="tooltip" data-bs-title="{{ $commissionLabel }}"></i>
            </div>
            <h3 class="mb-2">{{ $data['employee_commission'] }}</h3>
            <p class="mb-0">{{ $commissionLabel }}</p>
          </div>
      ...
      @if(!session('my_work_mode'))
        <div class="col-sm-6 col-lg-2">
          <div class="card dashboard-cards new-customer"
            ...
            <a href="{{ route('backend.employees.index') }}" class="card-body">
              <div class="d-flex align-items-start justify-content-end mb-1">
                <i class="fa-solid fa-circle-info" data-bs-toggle="tooltip" data-bs-title="{{ __('dashboard.lbl_staff') }}"></i>
              </div>
              <h3 class="mb-2">{{ $data['total_staff'] }}</h3>
              <p class="mb-0">{{ __('dashboard.lbl_staff') }}</p>
            </a>
          </div>
        </div>
      @endif
      <div class="col-sm-6 col-lg-2">
        <div class="card dashboard-cards appointments"
          ...
          <a href="{{ route('backend.orders.index') }}" class="card-body">
            <div class="d-flex align-items-start justify-content-end mb-1">
              <i class="fa-solid fa-circle-info" data-bs-toggle="tooltip" data-bs-title="{{ __('dashboard.lbl_orders') }}"></i>
            </div>
      ...
      <div class="col-sm-6 col-lg-2">
        <div class="card dashboard-cards services"
          ...
          <div class="card-body">
            <div class="d-flex align-items-start justify-content-end mb-1">
              <i class="fa-solid fa-circle-info" data-bs-toggle="tooltip" data-bs-title="{{ __('dashboard.lbl_product_sales') }}"></i>
            </div>
      ...
      @if(!auth()->user()->hasRole(['manager', 'employee']))
      <div class="col-sm-6 col-lg-2">
        <div class="card dashboard-cards new-customer"
          style="background-image: url({{ asset('img/dashboard/new-users.svg') }})">
      ...
      <div class="col-sm-6 col-lg-2">
        <div class="card dashboard-cards new-customer"
          ...
          <a href="{{ route('backend.customers.index') }}" class="card-body">
            <div class="d-flex align-items-start justify-content-end mb-1">
              <i class="fa-solid fa-circle-info" data-bs-toggle="tooltip" data-bs-title="{{ __('dashboard.lbl_returning_customers') }}"></i>
            </div>
  ...
  <div class="col-xl-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      @if(count($data['upcomming_appointments']) > 0)
                ...
                const options = {
                    ...
                    dataLabels: {
                        ...
                        formatter: function (val, opts) {
                            // Format only the Sales series (index 0) as amount with currency decimals
