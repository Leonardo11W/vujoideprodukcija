    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-lg-2">
        <div class="card dashboard-cards revenue"
          ...
          <div class="card-body">
            <div class="d-flex align-items-start justify-content-end mb-1">
              <i class="fa-solid fa-circle-info" data-bs-toggle="tooltip" data-bs-title="{{ __('dashboard.lbl_manager_commission') }}"></i>
            </div>
            <h3 class="mb-2">{{ $data['employee_commission'] }}</h3>
            <p class="mb-0">{{ __('dashboard.lbl_manager_commission') }}</p>
          </div>
