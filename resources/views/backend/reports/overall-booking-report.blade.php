  ...
  {{--          </button>--}}
                ...
                <x-slot name="toolbar">
                    <div class="input-group gap-2 flex-nowrap">
                        <input type="text" name="booking_date" id="booking_date" placeholder="{{ __('booking.booking_date') }}" class="booking-date-range form-control ms-2" readonly />
                        <select id="column_employee_id" data-placeholder="{{ __('employee.select_employee') }}" name="column_employee_id"
                            ...
                            data-ajax--data='{"branch_id": "{{ session("selected_branch") }}"}'
