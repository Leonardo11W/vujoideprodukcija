<form action="{{$url ?? ''}}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-stretch flex-md-row flex-column admin-quick-action">
  @csrf
  {{$slot}}
  ...
  <button class="btn btn-primary btn-sm" id="quick-action-apply">{{ __('messages.apply') }}</button>
</form>
