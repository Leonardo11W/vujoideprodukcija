...
<script type="text/javascript">
        ...
        { data: 'type', name: 'type', title: "{{ __('slider.lbl_type') }}",  width:'20%'},
        { data: 'link_id', name: 'link_id', title: "{{ __('slider.lbl_link_id') }}",  width:'20%'},
        { data: 'status', name: 'status', title: "{{ __('slider.lbl_status') }}", width:'20%'},
        {
            data: 'updated_at',
            name: 'updated_at',
