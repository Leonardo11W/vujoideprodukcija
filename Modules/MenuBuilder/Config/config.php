...
return [
    ...
    'ARRAY_MENU' => [
        ...
        [
            ...
            'menu_item_type' => 'static',
            'permission' => ['view_booking', 'view_branch', 'view_service'],
            'order' => 3,
        ],
        [
        ...
        [
            ...
            'children' => [
                ...
                [
                    ...
                    'permission' => ['view_service_subcategory'],
                    'order' => 2,
                    'menu_level' => 1,
                ],
            ],
        ...
        [
            ...
            'menu_item_type' => 'static',
            'permission' => ['reports_daily_booking_report', 'reports_overall_booking_report', 'reports_payout_report', 'reports_staff_report', 'view_product_orders_report'],
            'order' => 17,
        ],
        [
