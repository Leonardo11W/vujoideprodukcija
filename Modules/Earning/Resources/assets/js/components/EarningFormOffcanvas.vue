        ...
        <div class="border-bottom">
          <div class="d-flex align-items-center gap-3 mb-2">
            ...
            <div class="flex-grow-1">
              <div class="gap-2">
                <strong class="text-dark">{{ full_name }}</strong>
                <p class="m-0">
                  <small class="text-dark"><i class="fa-solid fa-envelope me-2"></i>{{ email }}</small>
                </p>
                <p class="m-0">
                  <small class="text-dark"><i class="fa-solid fa-phone me-2"></i>{{ mobile }}</small>
                </p>
              </div>
            </div>
          </div>
