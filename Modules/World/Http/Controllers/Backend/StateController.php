...
class StateController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // Keep backend screens protected, but allow `index_list` to be used
        // by public/API consumers without requiring panel permissions.
            ...
            ->editColumn('status', function ($data) {
                ...
                return '
                                <div class="form-check form-switch ">
                                    <input type="checkbox" data-url="'.route('backend.state.update_status', $data->id).'" data-token="'.csrf_token().'" class="switch-status-change form-check-input"  id="datatable-row-'.$data->id.'"  name="status" value="'.$data->id.'" '.$checked.' '.$disabled.'>
                                </div>
                            ';
            })
