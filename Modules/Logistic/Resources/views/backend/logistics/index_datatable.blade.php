        ...
        <div class="card-body">
            <x-backend.section-header>
                <div class="d-flex flex-wrap gap-3">
                    @if(auth()->user()->can('edit_logistics') || auth()->user()->can('delete_logistics'))
...
<script type="text/javascript" defer>
    const columns = [{
        ...
        const canShowActionColumn = {{ auth()->user()->can('edit_logistics') || auth()->user()->can('delete_logistics') ? 'true' : 'false' }};
        let finalColumns = [
            ...columns,
            ...customFieldColumns,
