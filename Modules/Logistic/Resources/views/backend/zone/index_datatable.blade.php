        ...
        <div class="card-body">
            <x-backend.section-header>
                <div class="d-flex flex-wrap gap-3">
                    @if(auth()->user()->can('edit_logistic_zone') || auth()->user()->can('delete_logistic_zone'))
                ...
                <x-slot name="toolbar">
                    ...
                    @hasPermission('add_logistic_zone')
...
<script type="text/javascript" defer>
    const columns = [{
        ...
        const canShowActionColumn = {{ auth()->user()->can('edit_logistic_zone') || auth()->user()->can('delete_logistic_zone') ? 'true' : 'false' }};
        let finalColumns = [
            ...columns,
