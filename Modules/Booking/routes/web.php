...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth','admin']], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'bookings', 'as' => 'bookings.'], function () {
        // Define edit route FIRST (before resource) to allow view_booking permission (permission check handled in controller)
    ...
    Route::resource('bookings', BookingsController::class)->except(['edit']);
});
