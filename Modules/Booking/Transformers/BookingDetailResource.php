...
class BookingDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'branch_mail' => optional($this->branch)->contact_email ?? '-',
            'branch_image' => optional($this->branch)->feature_image ?? '-',
            ...
            'user_email' => optional($this->user)->email ?? null,
            'user_phone' => optional($this->user)->mobile ?? null,
