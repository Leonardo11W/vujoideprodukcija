              ...
              <nav aria-label="Pagination">
                ...
                >
                  ...
                  <li class="page-item" :class="{ disabled: currentPage === 1 }">
                    <button @click="prevPage" class="page-link" :disabled="currentPage === 1">{{$t('messages.previous')}}</button>
                  </li>
                  ...
                  <li class="page-item" :class="{ disabled: currentPage === totalPages }">
                    <button @click="nextPage" class="page-link" :disabled="currentPage === totalPages">{{$t('messages.next')}}</button>
                  </li>
                </ul>
              </nav>
            </div>
      ...
      props: {
        ...
        options: {
          ...
          buttonText: function (texts) {
            ...
            texts.listWeek = t('messages.calendar_week')
            return texts
          },
          ...
          eventSources: [
            {
              ...
              const events = await createRequest(INDEX_URL(params)).then((res) => {
                  ...
                  if (business_hours) {
                    ...
                    // Update calendar options with new business hours
...
// Watch for branch changes and refetch events to update business hours
