...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth','admin']], function () {
    ...
    */
    ...
    Route::get('product-branches', [ProductsController::class, 'productBranchList']);
    ...
    Route::group(['prefix' => 'orders'], function () {
        ...
        // Route for AJAX order cancellation
        Route::post('cancel/{orderId}', [OrdersController::class, 'cancelOrder'])->name('orders.cancel');
