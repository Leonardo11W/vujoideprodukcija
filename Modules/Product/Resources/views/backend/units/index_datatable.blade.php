        ...
        <div class="card-body">
            <x-backend.section-header>
                <div class="d-flex flex-wrap gap-3">
                    @if(auth()->user()->can('edit_product_units') || auth()->user()->can('delete_product_units')||auth()->user()->can('status_product_units'))
                ...
                <x-slot name="toolbar">
                    ...
                    @hasPermission('add_product_units')
...
<script type="text/javascript" defer>
        ...
        const canShowActionColumn = {{ auth()->user()->can('edit_product_units') || auth()->user()->can('delete_product_units') ? 'true' : 'false' }};
        let finalColumns = [
            ...columns,
            ...customFieldColumns,
