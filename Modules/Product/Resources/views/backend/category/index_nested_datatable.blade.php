...
<div class="card">
  <div class="card-body">
    <x-backend.section-header>
      ...
      @canany(['edit_product_subcategory', 'delete_product_subcategory'])
...
<script type="text/javascript">
 ...
 const canShowActionColumn = {{ auth()->user()->hasAnyPermission(['edit_product_subcategory', 'delete_product_subcategory']) ? 'true' : 'false' }};
