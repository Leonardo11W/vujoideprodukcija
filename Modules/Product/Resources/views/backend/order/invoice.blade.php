                    ...
                    <div class="row justify-content-between align-items-center g-3 mb-4">
                        ...
                        <div class="col-auto text-end">
                            <h5 class="mb-0">Invoice
                                <span
                                    class="text-accent">{{ $order->orderGroup->formatted_order_code }}
                                </span>
                            </h5>
                ...
                <table class="invoice-table" data-use-parent-width="true">
                    ...
                    <tbody>
                        @foreach ($order->orderItems as $key => $item)
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <span class="fw-bold currency-font">{{ $item->discount_price > 0 ?  \Currency::format($item->original_price) : \Currency::format($item->unit_price) }}
                                    </span>
                                </td>
                                @if($hasDiscount)
                                    <td class="text-end">
                                        <span class="fw-bold currency-font">{{ $item->discount_price > 0 ? \Currency::format($item->discount_price) : '-' }}</span>
                                    </td>
                                @endif
                    ...
                    <tfoot class="text-end">
                        ...
                        <tr>
                            ...
                            <td width="15%" class="text-end currency-font"><strong
