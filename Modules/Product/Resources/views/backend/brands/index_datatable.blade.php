        ...
        <div class="card-body">
            <x-backend.section-header>
                <div class="d-flex flex-wrap gap-3">
                    @if(auth()->user()->can('edit_product_brand') || auth()->user()->can('delete_product_brand')||auth()->user()->can('status_product_brand'))
                ...
                <x-slot name="toolbar">
                    ...
                    @hasPermission('add_product_brand')
...
<script type="text/javascript" defer>
        ...
        const canShowActionColumn = {{ auth()->user()->can('edit_product_brand') || auth()->user()->can('delete_product_brand') ? 'true' : 'false' }};
        let finalColumns = [
            ...columns,
