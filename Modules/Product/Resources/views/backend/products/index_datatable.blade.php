        ...
        <div class="card-body">
            <x-backend.section-header>
                <div class="d-flex flex-wrap gap-3">
                    @if(auth()->user()->can('edit_product') || auth()->user()->can('delete_product')||auth()->user()->can('status_product'))
...
<script type="text/javascript" defer>
        ...
        const allCategoriesText = @json(__('product.all_categories'));
        const allBrandsText = @json(__('product.all_brands'));
        const columns = [
            {
                data: 'id',
                name: 'id',
        ...
        const canShowActionColumn = {{ auth()->user()->can('edit_product') || auth()->user()->can('delete_product') ? 'true' : 'false' }};
        let finalColumns = [
            ...columns,
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            function filtercategories(selectedBrandId) {
                ...
                $categorySelect.append('<option value="">' + allCategoriesText + '</option>');
