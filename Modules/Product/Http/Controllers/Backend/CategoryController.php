...
class CategoryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(['permission:view_product_category'])->only('index');
        $this->middleware(['permission:edit_product_category'])->only('edit', 'update');
        $this->middleware(['permission:add_product_category'])->only('store');
        $this->middleware(['permission:delete_product_category'])->only('destroy');

        $this->middleware(['permission:view_product_subcategory'])->only('index_nested');
    }
    ...
    public function index_list(Request $request)
    {
        ...
        // Filter categories by products in the current branch
    ...
    {
        $edit_permission = 'edit_product_category';
        $delete_permission = 'delete_product_category';
        $module_name = $this->module_name;
        ...
        ->addColumn('check', function ($data) {
            ...
            $hasActionPermission =
                $user->can('edit_product_category') ||
                $user->can('delete_product_category');
            ...
            ->editColumn('status', function ($row) {
                $canChangeStatus = auth()->user()->can('edit_product_category');
                ...
                return '
                    <div class="form-check form-switch d-flex justify-content-center">
                        <input 
                            ...
                            data-url="' . route('backend.products-categories.update_status', $row->id) . '"
    ...
    {
        $edit_permission = 'edit_product_subcategory';
        $delete_permission = 'delete_product_subcategory';
        $module_name = $this->module_name;
        ...
        ->addColumn('check', function ($data) {
            ...
            // Permissions that allow bulk actions on variations
            $hasActionPermission =
                $user->can('edit_product_subcategory') ||
                $user->can('delete_product_subcategory');
            ...
            ->editColumn('status', function ($row) {
                $canChangeStatus = auth()->user()->can('edit_product_subcategory');
                $checked = $row->status ? 'checked' : '';
                $disabled = $canChangeStatus ? '' : 'disabled';
