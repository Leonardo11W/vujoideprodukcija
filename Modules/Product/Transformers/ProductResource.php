...
class ProductResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'discount_value' => isActiveProductDiscount($this->resource) ? $this->discount_value : 0,
            ...
            'reviews' => ReviewResource::collection($this->product_review->where('review_msg', '!=', null)),
            'variation_data' => ProductVariationResource::collection($this->product_variations),
            'product_gallary' => $this->whenLoaded('gallery', function () {
                return $this->gallery->where('status', 1)->pluck('full_url')->values();
            }, []),
