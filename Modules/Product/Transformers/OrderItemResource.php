...
class OrderItemResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'id' => $this->id,
            'product_name' => $this->product_variation->product->name ?? null,
            'qty' => $this->qty,
            ...
            'get_product_price' => ($price = $this->product_variation?->price ?? null) !== null
                ? getDiscountedProductPrice((float) $price, $this->product_variation->product_id ?? 0)
                : null,
            'product_amount' => ($price = $this->product_variation?->price ?? null) !== null
                ? getDiscountedProductPrice((float) $price, $this->product_variation->product_id ?? 0) * $this->qty
                : null,
