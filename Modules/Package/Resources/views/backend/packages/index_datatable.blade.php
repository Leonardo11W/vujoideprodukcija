...
@section('content')
        ...
        <div class="card-body">
            <x-backend.section-header>
                <div class="d-flex flex-wrap gap-3">
                    @if (auth()->user()->can('edit_package') || auth()->user()->can('delete_package'))
                        <x-backend.quick-action url="{{ route('backend.package.bulk_action') }}">
                            ...
                            <div class="select-status d-none quick-action-field" id="change-status-action">
                                <select name="status" class="search-hide form-control select2" id="status"
                                    style="width:100%">
    ...
    <div data-render="app">
        <form-offcanvas default-image="{{ product_feature_image() }}"
            create-title="{{ __('messages.new') }} {{ __('package.singular_title') }}"
            edit-title="{{ __('messages.edit') }} {{ __('package.singular_title') }}"
