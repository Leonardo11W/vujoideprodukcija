  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="client-package-form" aria-labelledby="form-offcanvasLabel">
    ...
    <div class="offcanvas-body">
      ...
      <div>
        ...
        <div v-if="hasServices" class="table-responsive">
        ...
        <div v-else class="text-center py-3">
          <p class="text-muted mb-0">{{$t('package.lbl_no_service_remaining') || 'No service remaining'}}</p>
        </div>
      </div>
...
const hasServices = computed(() => {
  return packages.services && packages.services.length > 0;
});
</script>
