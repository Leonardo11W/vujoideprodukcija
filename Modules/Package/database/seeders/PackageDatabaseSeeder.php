        ...
        if (env('IS_DUMMY_DATA')) {
            foreach ($data as $key => $value) {
                ...
                foreach ($services as $svalue) {
                    $serviceItemsData[$svalue['service_id']] = [
                        'qty' => $svalue['qty'],
                        'service_price' => $svalue['service_price'],
                        'discounted_price' => $svalue['discounted_price'],
                        'service_name' => $svalue['service_name'],
                    ];
                }

                $package->serviceItems()->sync($serviceItemsData);
