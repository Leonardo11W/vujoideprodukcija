                        ...
                        <div class="iq-card-body">
                            <table class="iq-table-border mb-0" style="border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="width: 15em;" class="mb-2">{{booking.branch_address.country_data?.name || booking.branch_address.country}} / {{booking.branch_address.postal_code}}</p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
<div class="d-flex justify-content-between align-items-center mt-3">
  ...
  <h6><span id="dateOfAppointment">{{ moment(booking.start_date_time).format('YYYY-MM-DD') }}</span></h6>
</div>
<div class="d-flex justify-content-between align-items-center mt-3">
