...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth','admin']], function () {
    ...
    Route::group(['prefix' => 'employees', 'as' => 'employees.'], function () {
        ...
        Route::get('managers_list', [EmployeesController::class, 'managers_list'])->name('managers_list');
        ...
        Route::post('check-branch-availability', [EmployeesController::class, 'check_branch_availability'])->name('check_branch_availability');
    });
