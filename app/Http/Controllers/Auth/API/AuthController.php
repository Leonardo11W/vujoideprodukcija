...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        try {
            ...
            //     return $this->sendResponse($userResource, __('messages.not_verified'));
            // }
    ...
    public function login(LoginRequest $request)
    {
        ...
        // if (is_null($user->email_verified_at)) {
        //     return response()->json(['status' => false, 'message' => __('messages.not_verified')], 403);
        // }
        if (Auth::attempt(['email' => request('email'), 'password' => request('password')])) {
            ...
            // Check user role from database - allow manager or user role to login
            if (!$user->hasAnyRole(['manager', 'user', 'employee'])) {
        ...
        // If credentials are wrong, always return a JSON error response
        return response()->json([
            'status' => false,
            'message' => __('auth.failed') // or a custom message like 'Invalid credentials.'
        ], 401);
    }
    ...
    public function userDetails(Request $request)
    {
        ...
        return response()->json(['status' => true, 'data' => $userData, 'message' => __('messages.user_details_successfull')]);
    }
